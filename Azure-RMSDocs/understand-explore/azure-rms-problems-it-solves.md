...
> [!TIP]
> Se você tiver familiaridade com a versão local do Rights Management, o AD RMS (Active Directory Rights Management Services), talvez tenha interesse na tabela de comparação disponível em [Comparando o Azure Rights Management e o AD RMS](compare-azure-rms-ad-rms.md).
...
Para obter mais informações sobre essas certificações externas, consulte a [Central de Confiabilidade do Azure](http://azure.microsoft.com/support/trust-center/compliance/)..
